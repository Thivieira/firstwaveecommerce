const Privacidade = () => {
  return (
    <div style={{padding: '1rem 5rem', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column'}}>
      ...
      <p style={{width: '60%'}}>
        ...
        Se após você nos fornecer seus dados, você mudar de ideia, você pode retirar o seu consentimento para que possamos entrar em contato, para a coleção de dados contínua, uso ou divulgação de suas informações, a qualquer momento, entrando em contato conosco em contato@lifestyle.com.br ou nos enviando uma correspondência em: Lifestyle Floripa Rodovia Jornalista Manoel de Menezes, 2001

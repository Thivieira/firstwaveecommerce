    ...
    <>
        ...
        <div className="container">
          <div className="container-col">
            <div className="sec aboutus">
              <NavLink href="/">
                <img src="/footer-image.jpeg" alt="Logo do rodapé" className="footer-logo" />
              </NavLink>
            </div>
              ...
              <ul className="info">
                ...
                <span>
                  ...
                  <NavLink
                    ...
                    target="blank"
                  >
                    Rodovia Jornalista Manoel de Menezes, 2001. Anexo ao Hotel Selina - Praia Mole -
                    Florianópolis- SC
                  </NavLink>
                </span>
              </ul>
            ...
            <ul>
              <li>
                <a href="mailto:contato@lifestylesc.com.br">
                  <Mail style={{ marginRight: '5px' }} /> contato@lifestylesc.com.br
                </a>
              </li>
              <li>
      ...
      <div className="copyrightText">
        ...
        <span>
          ...
          <NavLink target="blank" href="https://devplans.com.br/">
            DevPlans LTDA
          </NavLink>
        </span>
      </div>

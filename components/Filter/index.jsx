...
import { getAllProducts, getAllProductSize, getAllProductColor, getAllProductBrands, getLoading } from "../../store/selectors/products"
import { getProducts, clearProducts, setLoading } from "../../store/actions/products";
...
function Filter() {
    ...
    const subcategoria = router.query.subcategoria;
            ...
            <div className="filter-option-price">
                ...
                <div className="price-input">
                    <TextField
                        ...
                        size="small"
                        error={
                            selectedPriceMax < selectedPriceMin ? true : false
                        }
                    />
                </div>
            </div>
